...
router.post('/create', async (req, res) => {
    ...
    try {
        ...
        `;
        const result = await db.query(query, [name, creator_user_id, table_id]);
        const group_id = result.rows[0].ordergroup_id;
        console.log('Grupo creado con éxito:', group_id);

        // Agregamos al creador como miembro del grupo
        ...
        console.log('El creador del grupo ha sido añadido como miembro del grupo.');
